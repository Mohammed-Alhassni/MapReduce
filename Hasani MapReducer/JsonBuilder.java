...
public class JsonBuilder {
    ...
    public static void convertCSVToJSON() throws CsvValidationException {
        ...
        try (CSVReader reader = new CSVReader(new FileReader(BuildDataset.csvPath))) {
            ...
            mapper.writeValue(new File(BuildDataset.jsonPath), data);

            System.out.println(" JSON file created: " + BuildDataset.jsonPath);
